...
const features = [
  {
    ...
    desc: "From anywhere and at any time.  ",
  },
  { img: W2, title: "Easy Access", desc: "Accessible whenever you require it" },
  {
    img: W3,
    title: "Monitoring System",
    desc: "To ensure the safety of your items",
  },
  ...
  { img: W6, title: "Certified", desc: "from Saudi food & drug authority" },
  {
    ...
    desc: "  To make it easier for you.  ",
  },
  ...
  return (
    <div className="info-container">
      ...
      <div className="info-text">
        <h4>
          Tailored Storage Services for{" "}
          <span className="info-text-span">Businesses 🤩</span>
        </h4>
        <p>
          Unlock seamless business operations with our tailored storage
          solutions at Makhzny. Our comprehensive business storage services
          provide a secure and organized space for your company’s assets. From
          document archives to inventory management.
        </p>
      </div>
